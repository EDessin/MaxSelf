...
const (
	...
	TypeMobility           ActivityType = "mobility"
...
func Rules() []ActivityRule {
	return applyCategoryColors([]ActivityRule{
		...
		{Type: TypeExercise, Title: "Resistance Training", XP: 40, Stat: StatStrength, Icon: "dumbbell", Goal: "10+ min resistance training"},
		{Type: TypeMobility, Title: "Mobility Session", XP: 20, Stat: StatStrength, Icon: "person-standing", Goal: "10+ min mobility"},
		...
		{Type: TypeRecovery, Title: "Recovery Ritual", XP: 20, Stat: StatRecovery, Icon: "stretch-horizontal", Goal: "10+ min stretching"},
