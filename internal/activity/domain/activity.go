...
func Rules() []ActivityRule {
	return []ActivityRule{
		...
		{Type: TypeDailyStepsBronze, Title: "Daily Steps — Bronze", XP: 20, Stat: StatCardio, Icon: "footprints", Color: "#cd7f32", Tier: "Bronze", ThresholdValue: 6000, ThresholdUnit: "steps", FollowUpType: TypeDailyStepsSilver},
		{Type: TypeDailyStepsSilver, Title: "Daily Steps — Silver", XP: 30, Stat: StatCardio, Icon: "footprints", Color: "#94a3b8", Tier: "Silver", ThresholdValue: 8000, ThresholdUnit: "steps", FollowUpType: TypeDailyStepsGold, PrerequisiteType: TypeDailyStepsBronze},
		...
		{Type: TypeDailyStepsDiamond, Title: "Daily Steps — Diamond", XP: 70, Stat: StatCardio, Icon: "footprints", Color: "#67e8f9", Tier: "Diamond", ThresholdValue: 15000, ThresholdUnit: "steps", PrerequisiteType: TypeDailyStepsGold},
		...
		{Type: TypeHydrationBronze, Title: "Hydration Boost — Bronze", XP: 10, Stat: StatFuel, Icon: "droplet", Color: "#cd7f32", Tier: "Bronze", ThresholdValue: 500, ThresholdUnit: "ml", FollowUpType: TypeHydrationSilver},
		{Type: TypeHydrationSilver, Title: "Hydration Boost — Silver", XP: 15, Stat: StatFuel, Icon: "droplet", Color: "#94a3b8", Tier: "Silver", ThresholdValue: 1000, ThresholdUnit: "ml", FollowUpType: TypeHydrationGold, PrerequisiteType: TypeHydrationBronze},
		{Type: TypeHydrationGold, Title: "Hydration Boost — Gold", XP: 20, Stat: StatFuel, Icon: "droplet", Color: "#f59e0b", Tier: "Gold", ThresholdValue: 1500, ThresholdUnit: "ml", FollowUpType: TypeHydrationDiamond, PrerequisiteType: TypeHydrationSilver},
		{Type: TypeHydrationDiamond, Title: "Hydration Boost — Diamond", XP: 30, Stat: StatFuel, Icon: "droplet", Color: "#67e8f9", Tier: "Diamond", ThresholdValue: 2000, ThresholdUnit: "ml", PrerequisiteType: TypeHydrationGold},
